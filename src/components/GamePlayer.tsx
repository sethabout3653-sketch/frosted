...
export default function GamePlayer({ game, onBack, onOpenCall }: GamePlayerProps) {
        ...
        <div className="ml-auto flex items-center gap-2">
          {onOpenCall && (
            <button
              id="player-call-btn"
              onClick={onOpenCall}
              className="flex h-8 items-center justify-center rounded-lg border border-emerald-800/80 bg-emerald-950/80 hover:bg-emerald-900 px-2.5 text-xs font-bold text-emerald-400 hover:text-white transition-all cursor-pointer shadow-sm active:scale-95"
              title="Call Friends"
            >
              <Phone size={13} className="mr-0 sm:mr-1.5" />
