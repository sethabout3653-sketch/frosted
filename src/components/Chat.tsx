  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 bg-white text-black p-4 rounded-full shadow-2xl hover:scale-105 transition-transform"
      >
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex justify-end">
          ...
          <div className="relative w-full max-w-sm h-full bg-black border-l border-neutral-800 flex flex-col animate-in slide-in-from-right shadow-2xl">
            {/* Header Tabs */}
            <div className="flex items-center justify-between p-2 border-b border-neutral-800 bg-neutral-900/50">
